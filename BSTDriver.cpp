 ...
 // bst_iter->setInorder();  //takes a snapshot of the data
   ...
   */
   ...
   //display whether the binary search tree is balanced (should not be balanced)
	...
	cout << "The height of the normal BST before any modifications " << height << endl;
	if (balanced == 0)
	{
 ...
 /*  
   ...
   */
   ...
   //display whether the binary search tree is balanced (should be balanced)
	...
	int newHeight = min_bst->getHeight();
	bool newBalanced = min_bst->isBalanced();
	cout << "The height of the Minimum BST is: " << newHeight << endl;
 ...
 //  bst_iter = complete_bst->iterator();
   ...
   */
   ...
   //display whether the binary search tree is balanced (should be balanced)
	...
	int newNewHeight = complete_bst->getHeight();
	bool newNewBalanced = complete_bst->isBalanced();
	cout << "The Height of the Complete BST is: " << newNewHeight << endl;
	if (newNewBalanced == 0)
	{
		cout << "This tree is not Balanced" << endl;
	}
